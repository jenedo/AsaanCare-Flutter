...
android {
    namespace = "com.asaancare.app"

    // Required after adding native Android plugins such as file_picker.
    // Do not use flutter.compileSdkVersion here because your current Flutter/Android setup is resolving it as 34.
    compileSdk = 36
